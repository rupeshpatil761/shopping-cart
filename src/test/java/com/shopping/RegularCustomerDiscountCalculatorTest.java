...
import com.shopping.service.impl.RegularCustomerDiscountCalculator;

@RunWith(MockitoJUnitRunner.class)
public class RegularCustomerDiscountCalculatorTest {

	@Mock
	CustomerDao customerDao;
	
	@InjectMocks
	RegularCustomerDiscountCalculator discountCalculator;
